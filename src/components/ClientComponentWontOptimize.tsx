...
export const ClientComponentWontOptimize = ({description,name}: {description: string;name: string}): ReactElement => {
    return (
        <div>
            <p>{name}</p>
            <p>{description}</p>
            <p>{`Banh mi yr fanny pack sus, pour-over letterpress food truck marxism coloring book sartorial cardigan lomo lyft tumblr cloud bread. Vinyl sartorial umami, bodega boys photo booth food truck freegan 8-bit polaroid hashtag stumptown hell of 90's cronut keytar. Meh crucifix beard bodega boys portland, you probably haven't heard of them YOLO. Quinoa typewriter lo-fi, copper mug heirloom glossier hexagon neutral milk hotel fam palo santo knausgaard af leggings. VHS pinterest twee biodiesel, tacos small batch street art scenester church-key art party.
...
Direct trade marfa typewriter, semiotics authentic marxism hella fingerstache chillwave. PBR&B bruh Brooklyn, vaporware YOLO tacos fanny pack occupy coloring book street art DIY pour-over prism. Marfa kinfolk offal cronut disrupt godard gastropub. Butcher banh mi venmo lumbersexual. Occupy organic pour-over fixie photo booth. XOXO butcher occupy try-hard, single-origin coffee offal lomo fam VHS art party vexillologist la croix. Shaman meh tattooed jianbing slow-carb occupy authentic etsy wolf tumblr tbh.`}</p>
